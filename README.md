...
- 🥅 2022 Goals: Contribute more to Open Source projects, learning web3.0, data visualization and Golang
- ⚡ Fun fact: I love to write and play games

```javascript
const aboutMe = {
   pronouns: "he" | "him",
   code: ["Javascript", "React", "Node", "Typescript", "HTML", "CSS", "PHP", "Golang", "Python"],
   technologies: {
      frontEnd: {
         js: ["React", "Vue"],
